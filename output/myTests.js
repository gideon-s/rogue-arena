...
(function() {
  ...
  test("path contains expected path to destination, nextStep contains the first location in the path", function() {
    var destLocation, location, map, nextStep, path;
    map = new Map(10, 10);
    ...
    return deepEqual(nextStep, new Location([2, 2]));
  });
  ...
  test("edgeLocations contain map edge coordinates", function() {
    var map;
    map = new Map(2, 2);
    return deepEqual(map.edgeLocations(), [new Location([0, 0]), new Location([0, 1]), new Location([1, 0]), new Location([1, 1])]);
  });
