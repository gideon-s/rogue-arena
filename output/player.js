...
(function() {
  ...
  window.Player = (function(_super) {
    ...
    Player.prototype.hitBy = function(entity) {
      ...
      return Player.__super__.hitBy.call(this, entity);
    };
    ...
    Player.prototype.changeWeapon = function() {
      var allKeys, changed, doChange, weps;
      changed = false;
      ...
      $.cookie.json = true;
      allKeys = _.union(this.modKeys, ['main']);
      console.log(this.weapons);
      weps = _.object(allKeys, _.map(allKeys, (function(_this) {
        return function(k) {
          if (_this.weapons[k] != null) {
            return _this.weapons[k].constructor.name;
          } else {
            return '';
          }
        };
      })(this)));
      return $.cookie("weapons", weps);
    };
